...
class TestMyStack(unittest.TestCase):
    ...
    def test_peek_in_non_empty_stack(self):
        ...
        self.assertEqual(actual_value, expected_value,
                msg='test_peek_in_non_empty_stack (value)') \  # noqa: E128
    ...
    def test_reverse_non_empty_stack(self):
        ...
        self.assertEqual(actual_value, expected_value,
                         msg='test_reverse_non_empty_stack')
...
if __name__ == '__main__':
    ...
    print('timeit: generating {} random values up to {} {}'.format(
        size, range_values, duration))
    ...
    endtime = timeit.default_timer()
    duration = endtime - starttime
    print('timeit: MyStack.push()     {} times {}'.format(size, duration))
    ...
    endtime = timeit.default_timer()
    duration = endtime - starttime
    print('timeit: MyStack.pop()      {} times {}'.format(size, duration))
    ...
    endtime = timeit.default_timer()
    duration = endtime - starttime
    print('timeit: MyStack.peek()     {} times {}'.format(size, duration))
    ...
    endtime = timeit.default_timer()
    duration = endtime - starttime
    print('timeit: MyStack.find_max() {} times {}'.format(size, duration))
